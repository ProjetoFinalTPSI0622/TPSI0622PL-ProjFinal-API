...
<head>
    ...
    <link
        href="https://fonts.googleapis.com/css2?family=Inter+Tight:wght@700&amp;family=Inter:wght@400;500;600&amp;display=swap"
                                    ...
                                    <tr>
                                        <td class="t6" style="padding:20px 10px 20px 10px;">
                                            <div class="t12"
                                                ...
                                                <div class="t16"
                                                    style="display:inline-table;text-align:initial;vertical-align:inherit;width:100%;max-width:480px;">
                                                    <table role="presentation" width="100%" cellpadding="0"
                                                        cellspacing="0" class="t18">
                                                        <tr>
                                                            <td class="t19">
                                                                    ...
                                                                    <tr>
                                                                        <td>
                                                                            <table class="t24" role="presentation"
                                                                                ...
                                                                                <tr>
                                                                                    <td class="t25"
                                                                                        style="background-color:#FFFFFF;padding:0 30px 0 30px;">
                                                                                        <div class="t31"
                                                                                            style="display:inline-table;width:100%;text-align:center;vertical-align:top;">
                                                                                            <div class="t35"
                                                                                                style="display:inline-table;text-align:initial;vertical-align:inherit;width:100%;max-width:480px;">
                                                                                                <table
                                                                                                    ...
                                                                                                    <tr>
                                                                                                        <td class="t38"
                                                                                                            style="border-bottom:2px solid #009FE3;overflow:hidden;background-color:#FFFFFF;padding:20px 30px 20px 30px;border-radius:8px 8px 0 0;">
                                                                                                            <table
                                                                                                                role="presentation"
                                                                                                                width="100%"
                                                                                                                cellpadding="0"
                                                                                                            ...
                                                                                                            <table
                                                                                                                ...
                                                                                                                <tr>
                                                                                                                    <td class="t63"
                                                                                                                        style="width:480px;">
                                                                                                                        <h1 class="t69"
                                                                                                                            style="margin:0;Margin:0;font-family:BlinkMacSystemFont,Segoe UI,Helvetica Neue,Arial,sans-serif,'Inter Tight';line-height:40px;font-weight:700;font-style:normal;font-size:35px;text-decoration:none;text-transform:none;direction:ltr;color:#312052;text-align:left;mso-line-height-rule:exactly;mso-text-raise:2px;">
                                                                                                                            Olá
                                                                                                                            !
                                                                                                                        </h1>
                                                                                                                    </td>
                                                                                                ...
                                                                                                <table class="t82"
                                                                                                    ...
                                                                                                    <tr>
                                                                                                        <td class="t83"
                                                                                                            style="width:480px;">
                                                                                                            <p class="t89"
                                                                                                                style="margin:0;Margin:0;font-family:BlinkMacSystemFont,Segoe UI,Helvetica Neue,Arial,sans-serif,'Inter';line-height:23px;font-weight:400;font-style:normal;font-size:16px;text-decoration:none;text-transform:none;direction:ltr;color:#545454;text-align:left;mso-line-height-rule:exactly;mso-text-raise:2px;">
                                                                                                                Pode
                                                                                                                iniciar
                                                                                                                sessão
                                                                                                                clicando
                                                                                                ...
                                                                                                <table class="t102"
                                                                                                    ...
                                                                                                    <tr>
                                                                                                        <td class="t103"
                                                                                                            ...
                                                                                                            <a class="t109"
                                                                                                                href="https://cesaedesk.atec-porto.eu/login"
